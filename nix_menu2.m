function k = nix_menu2(xHeader,varargin)
...
a =  get(0,'ScreenSize');
winTopGap   = a(4)/2-30;       % gap between top of screen and top of figure **
winLeftGap  = a(3)/2-25;       % gap between side of screen and side of figure **
